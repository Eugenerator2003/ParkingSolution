...
namespace ParkingWebApplication.Controllers
{
    public class CarsController : Controller
    {
        ...
        {
            var parkingContext = _context.Cars.Include(c => c.CarMark).Include(c => c.Owner);
        ...
        {
            ViewData["CarMarkId"] = new SelectList(_context.CarMarks, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,Number,CarMarkId,OwnerId")] Car car)
        {
            ...
            ViewData["CarMarkId"] = new SelectList(_context.CarMarks, "Id", "Id", car.CarMarkId);
